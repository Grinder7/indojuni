                    ...
                    <div class="card bg-dark">
                        <div class="card-body">
                            <div class="invoice-title">
                                <h4 class="font-size-15 float-end">
                                    Invoice#{{ $invoiceData['order_detail']->id }}
                                </h4>
                                <div class="mb-4">
                            ...
                            <div class="py-2">
                                <div class="table-responsive">
                                    <table class="table-nowrap table-centered mb-0 table align-middle">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    Rp{{ number_format($invoiceData['order_detail']->total, 2, ',', '.') }}
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="border-0 text-end">
                                                    Rp{{ number_format(floor($invoiceData['order_detail']->total * 0.11), 2, ',', '.') }}
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-0 text-end">
                                                    <h4 class="fw-semibold m-0">
                                                        Rp{{ number_format($invoiceData['order_detail']->total + floor($invoiceData['order_detail']->total * 0.11), 2, ',', '.') }}
                                                    </h4>
                                                </td>
                                            </tr>
                                        </tbody>
